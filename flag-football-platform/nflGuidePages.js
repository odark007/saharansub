...
export const NFL_GUIDE_PAGES = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    closingCTA: {
      ...
      creator: {
        name: 'Coach Goddie',
        tagline: 'NFL Flag coach, educator & platform creator',
        socials: [
          { platform: 'tiktok',   url: 'https://tiktok.com/@coachgoddie',   label: 'TikTok' },
          { platform: 'youtube',  url: 'https://youtube.com/@coachgoddie',  label: 'YouTube' },
          { platform: 'linkedin', url: 'https://linkedin.com/in/coachgoddie', label: 'LinkedIn' },
          { platform: 'twitter',  url: 'https://twitter.com/coachgoddie',   label: 'Twitter / X' },
        ],
      },
    },
  },
